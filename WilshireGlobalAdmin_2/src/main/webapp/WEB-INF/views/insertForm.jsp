...
<script>
	function insertSubmit(){
		var url="/admin/adminInsert";
		$("#wilshireForm").attr("action", url).submit();
	}
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <form  id="wilshireForm"  name="wilshireForm" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        <textarea rows="20" class="form-control" title="구성내용" id="formation" name="formation"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <label class="radio-inline">
                    	<input type="radio" name="workType" id="conference" value="1"> conference
	                </label>
	                <label class="radio-inline">
	                    <input type="radio" name="workType" id="exhibition" value="2"> exhibition
	                </label>
	                <label class="radio-inline">
	                    <input type="radio" name="workType" id="convention" value="3"> convention
	                </label>
	                <label class="radio-inline">
	                    <input type="radio" name="workType" id="design" value="4"> design
	                </label>
                    <div class="form-group">
                    ...
                    <button type="button" class="btn btn-default" onclick="javascript:insertSubmit();">등록</button>
                    <button type="button" class="btn btn-default" onclick="javascript:backAdminList();">목록으로 돌아가기</button>
                </form>
